//DEPRECATED CLASS, USE LUA SCRIPTING INSTEAD! (C++ SCRIPTING IS UNAVAILABLE NOW, ONLY USE C++ FOR INTERNAL ENGINE BINDINGS, NOT GAMES!)
//ANOTHER NOTE: C++ GAME ENTITIES ARE NOT SUPPORTED ANYMORE, ONLY LUA SCRIPTS CAN BE USED AS ENTITIES
